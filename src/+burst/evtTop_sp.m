function [riseLst,datR,evtLst,seLst,evtAllSp] = evtTop_sp(dat,dF,svLst,riseX,opts,ff,bd)
...
%             dF0,seMap0,nn,ihw0,rgh,rgw,rgt,it0,T,opts,1);
        ...
        [evtRecon,evtL,evtMap,dlyMap,nEvt0,rgtx,rgtSel,evtSp] = burst.se2evt_sp(...
            dF0,seMap0,nn,ihw0,rgh,rgw,rgt,it0,T,opts,1);
        ...
        for kkk = 1:numel(evtSp)
            evtAllSp{kkk+nEvt} = evtSp{kkk};
        end
