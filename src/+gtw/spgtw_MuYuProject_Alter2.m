function [spLst,cx0,tDly,neiLst,sv_spLabels,rgt00,isFail] = spgtw_MuYuProject_Alter2(...
...
%     [ref,tst0,refBase,s,t,~,orgCurves0,stds] = gtw.sp2graph_alter3(dFVec,curSp,majorInfo{kk},spMap1,unique(it));
    ...
    %% GTW
    [ ss,ee,gInfo ] = gtw.buildGTWGraph( ref, tst0, s, t, smoBase, maxStp, s2);
