function [svLabel] = riseMap2evtMuYu_Alter2(spLst,tDly,neibLst,sv_spLabels,maxRiseUnc,cDelay,sz)
...
for i = 1:numel(seedLabel)
    ...
    nonWeak = checkWhetherTrueSeed(curLabel,tDly,neibLst,maxRiseUnc,LeftSeeds);
    if(~nonWeak)
