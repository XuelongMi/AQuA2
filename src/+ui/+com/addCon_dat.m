...
% view control
str00 = {'Raw','Raw + overlay','Rising map','Maximum Projection','Average Projection','Rising map', 'dF'};
...
uicomponent(pImgCon,'style','slider','Tag','sldMov','Callback',{@ui.mov.stepOne,f});  % Java
...
uix.Empty('Parent',pImgCon);
pImgCon.Widths = [15,50,50,-1,40,40,30];
