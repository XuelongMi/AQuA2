function [evtRecon,evtL,evtMap,dlyMap,nEvt0,rgtx,rgtSel,spCell] = se2evt_sp(...
...
[evtL,evtRecon,spCell] = gtw.evtRecon_observe_sp(spLst,cx1,evtMap,minShow,rgtx,rgh,rgw);
evtRecon = evtRecon.^2;
